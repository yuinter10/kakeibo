...
return {
  ...
  const saveFixedCost = () => {
    ...
    if (editingFixedCost) {
  updateMonthlyFixedCost(currentMonthKey, editingFixedCost.id, {
    ...
    <span className="rounded-full bg-white/20 px-3 py-1 text-xs font-extrabold text-white">
      ...
      <div className="-mt-6 flex gap-4 px-6">
        ...
        <div className="flex-1 rounded-3xl border border-gray-100 bg-white p-3 shadow-lg">
          ...
          className="w-full resize-none border-0 bg-transparent px-0 py-1 !text-[13px] !font-medium leading-relaxed text-gray-700 outline-none placeholder:!text-[11px] placeholder:font-medium placeholder:text-gray-300 focus:ring-0"
style={{
  minHeight: '56px',
  lineHeight: '1.5',
}}
